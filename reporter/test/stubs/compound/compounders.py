...
class TestData(NamedTuple):
    COMPOUNDERS: list[Compounder]
    NON_COMPOUNDERS: list[EthereumAddress]
    CLAIMOORS: list[EthereumAddress]
...
COMPOUNDERS_PRV = [
    (
        "0x42F9169cEd1C30Ba7e92312F8E93fbc9B1FD2F26",
        "2498026159571371249",
        "69861597437725400000",
    ),
    (
        "0xD9FB0f6CDE530342793f4A4e600Bc49FE8ce3E62",
        "2324861546384188872",
        "65018751236699800000",
    ),
    (
        "0x7a218B680acB9D60dc8B8bC73B5dD7Ec3E671878",
        "911557936721782185",
        "25493285317455600000",
    ),
    (
...
TestDataARV = TestData(
    COMPOUNDERS=[Compounder(*c) for c in COMPOUNDERS_ARV],
    NON_COMPOUNDERS=[
        "0xC9EF3A5f54d1122898fc36AC4d25AD5DC40ad620",
        "0x9fa203C0526b71acD52699E6C16744cD5873B09D",
        "0xB70B56B84b76c823D35b72D5566f5C341Ed13ad2",
...
TestDataPRV = TestData(
    COMPOUNDERS=[Compounder(*c) for c in COMPOUNDERS_PRV],
    NON_COMPOUNDERS=[
        "0xCafF1dac2eD451a0C9F61e6445175048974E35a7",
        "0x559032700A79af643A149DF1432dB284C48E524b",
        "0x7024D6F89C2ADF88904812728cA68730eABBA23D",
